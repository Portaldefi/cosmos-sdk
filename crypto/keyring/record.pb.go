...
type Record_Openbao struct {
	Openbao *Record_OpenBao `protobuf:"bytes,7,opt,name=openbao,proto3,oneof" json:"openbao,omitempty"`
}
...
func (m *Record) GetOpenbao() *Record_OpenBao {
	if x, ok := m.GetItem().(*Record_Openbao); ok {
		return x.Openbao
	}
	return nil
}
...
func (m *Record_OpenBao) Reset()         { *m = Record_OpenBao{} }
func (m *Record_OpenBao) String() string { return proto.CompactTextString(m) }
func (*Record_OpenBao) ProtoMessage()    {}
func (*Record_OpenBao) Descriptor() ([]byte, []int) {
	return fileDescriptor_36d640103edea005, []int{0, 4}
}
func (m *Record_OpenBao) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Record_OpenBao) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Record_OpenBao.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Record_OpenBao) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Record_OpenBao.Merge(m, src)
}
func (m *Record_OpenBao) XXX_Size() int {
	return m.Size()
}
func (m *Record_OpenBao) XXX_DiscardUnknown() {
	xxx_messageInfo_Record_OpenBao.DiscardUnknown(m)
}

var xxx_messageInfo_Record_OpenBao proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*Record_OpenBao)(nil), "cosmos.crypto.keyring.v1.Record.OpenBao")
}
...
var fileDescriptor_36d640103edea005 = []byte{
	...
	,
}
...
func (m *Record_Openbao) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Record_Openbao) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Openbao != nil {
		{
			size, err := m.Openbao.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Record_OpenBao) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Record_Openbao) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Record) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Openbao", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *Record_OpenBao) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: OpenBao: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: OpenBao: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
